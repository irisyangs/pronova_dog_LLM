...
def save_content_to_files(url):
    ...
    os.makedirs('ScrapedFiles_petMD_symptoms', exist_ok=True)
    
    # Save the text content to a txt file in the ScrapedFiles folder
    filepath = os.path.join('ScrapedFiles_petMD_symptoms', filename)
    ...
    json_filename = 'sources_petMD_symptoms.json'
