...
def save_content_to_files(url):
    ...
    os.makedirs('ScrapedFiles_petMD_care_healthy_living', exist_ok=True)
    
    # Save the text content to a txt file in the ScrapedFiles folder
    filepath = os.path.join('ScrapedFiles_petMD_care_healthy_living', filename)
    ...
    json_filename = 'sources_petMD_care_healthy_living.json'
...
urls = extract_hrefs_from_divs("https://www.petmd.com/dog/care")
