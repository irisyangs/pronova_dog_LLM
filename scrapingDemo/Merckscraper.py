...
def save_content_to_files(url):
    ...
    os.makedirs('ScrapedFiles_merckvetmanual_dog_owners', exist_ok=True)
    
    # Save the text content to a txt file in the ScrapedFiles folder
    filepath = os.path.join('ScrapedFiles_merckvetmanual_dog_owners', filename)
    ...
    json_filename = 'sources_merckvetmanual_dog_owners.json'
...
urls = extract_hrefs_from_divs("https://www.merckvetmanual.com/dog-owners")
...
for url in urls:
    print("https://www.merckvetmanual.com/" + url)
